...
| Hardware 3D rendering  | Needed for the [G-code viewer](/interface/gcode-viewer), and for the map on the [bed mesh module](/interface/modules#bed-mesh), which needs WebGL 2 specifically. Without it, bed mesh still shows its axis numbers and probed readings, but not the rendered map. |
